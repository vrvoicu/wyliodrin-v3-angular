...
var module = angular.module("wyliodrin_v3", ['satellizer', 'ngRoute'])
    .config(function($authProvider, $routeProvider) {
        ...
        $authProvider.facebook({
            ...
            url: 'http://'+address+':8080/users/facebook'
        });

        $authProvider.google({
            clientId: '329239008240-b4f5d712bmf1660eudulrj389v8a14dg.apps.googleusercontent.com',
            url: 'http://'+address+':8080/users/google'
        });

        $authProvider.github({
            clientId: '67dc8adc092bdd00951d',
            url: 'http://'+address+':8080/users/github'
        });

        $authProvider.signupUrl = 'http://'+address+':8080/users/register';
        $authProvider.loginUrl = 'http://'+address+':8080/users/login';
